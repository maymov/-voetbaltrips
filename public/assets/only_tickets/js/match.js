 $("body").on("click", "#addtocart", function () {
        window.location.href = window.location.protocol + "//" + window.location.hostname + '/tickets/travellerinfo/' + $("#match_id").val();
    });
            ...
            success: function (resp) {
                if (resp.status == "success") {
                    ...
                    $('#modal2-confirm').on("click", function () {
                        ...
                        showTicketPrice();
                       // $.when(showTicketPrice()).then(window.location.reload());
                    });
 ...
 var saveSeatingTicket = function () {
     ...
     if (typeof ticket == "undefined") {
         ...
         $.ajax({
             url: window.location.protocol + "//" + window.location.hostname + "/ticketsave/" + $("#match_id").val(),
             dataType: "json",
