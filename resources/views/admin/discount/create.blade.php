                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-wizard form-horizontal" action="{{ route('admin.discount.store') }}" method="POST">
                                <!-- CSRF Token -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="value" type="number" step="0.01" placeholder="Discount value" class="form-control required" value="{!! Input::old('value') !!}" />
                                    </div>
                                </div>
