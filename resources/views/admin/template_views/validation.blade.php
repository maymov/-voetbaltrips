            ...
            <div class="col-md-6">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form role="form">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-md-6">
                                        <input type="submit" class="btn btn-primary btn-block btn-md btn-responsive"
                                               value="Register">
                                    </div>
                                    <div class="col-xs-6 col-md-6">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>
                                            ...
                                            perferendis rem nisi tempore possimus ipsa porro delectus quidem dolorem ad.
                                        </p>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" class="form-horizontal">
                        <form method="post" id="form" action={{asset('assets/vendors/securimage/image_valid.php') }}>
                            <div class="row">
                            ...
                            <div class="row">
                                <img id="captcha" src="{{ asset('assets/vendors/securimage/securimage_show.php') }}"
                            ...
                            <div class="row mar-10">
                                ...
                                <a href="#"
                                   onclick="document.getElementById('captcha').src = '{{ asset('assets/vendors/securimage/securimage_show.php?') }}' + Math.random(); return false"><i
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/jasny-bootstrap/js/jasny-bootstrap.min.js') }}"
            type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/validation/dist/js/bootstrapValidator.min.js') }}"
            type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/intl-tel-input/build/js/intlTelInput.min.js') }}"
            type="text/javascript"></script>
