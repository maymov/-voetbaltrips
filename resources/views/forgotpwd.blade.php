        ...
        <div class="box animation flipInX">
            ...
            <form class="omb_loginForm" autocomplete="off" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control email" id="email" name="email" placeholder="Email" value="{!! Input::old('email') !!}">
                    {{--<span class="help-block">@if($errors){{ $errors->first('email', ':message') }}@endif</span>--}}
                </div>
                <div class="form-group">
                    <button class="form-control btn btn-primary btn-block" name="submit" type="submit">Reset Your Password</button>
                </div>
            </form>
        </div>
    </div>
