            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="form-group {{ $errors->first('gender', 'has-error') }}">
                    ...
                    <label class="radio-inline">
                        <input type="radio" name="gender" required="required" id="inlineRadio1" value="male"> Male
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="gender" required="required" id="inlineRadio2" value="female"> Female
                    </label>
