                ...
                <div class="tr1-info">
                    <form method="post" name="frmtravelinfo" id="frmtravelinfo" action="{!! url("match/".$match_id."/savetravellerinfo") !!}" enctype="multipart/form-data">
                        ...
                        <div class="form-group text-center">
                            <a style="margin-right:10px;" href="{{url("match/".$match_id."/extras")}}" class="btn btn-info btn-nm">
                                <span class="glyphicon glyphicon-backward"></span> {{Translater::getValue('button-back-to-options-page')}}
                            </a>
